	...
	<tbody>
		...
		<c:forEach var="board" items="${list }">
			<tr>
				...
				<td><a href="getBoard.do?page=${paging.page }&bno=${board.boardNo}">${board.title }</td>
				<td>${board.writer }</td>
				<td>${board.viewCnt }</td>
...
<nav aria-label="...">
	<ul class="pagination">
		<li class="page-item ${paging.prev ? '' : 'disabled' }"><a
			class="page-link" href="boardList.do?page=${paging.startPage-1 }">Previous</a>
		</li>
		...
		<li class="page-item ${paging.next ? '' : 'disabled' }"><a
			class="page-link" href="boardList.do?page=${paging.endPage+1 }">Next</a></li>
	</ul>
</nav>
